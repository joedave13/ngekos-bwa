...
@section('content')
    ...
    <div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
        <a href="{{ route('transaction.customer-information') }}"
            ...
            <div class="flex gap-4">
                ...
                <div class="flex flex-col gap-3 w-full">
                    ...
                    <p class="font-semibold text-lg text-ngekos-orange">Rp
                        {{ number_format($data['boarding_house_price'], 0, ',', '.') }}</p>
                </div>
            </div>
    ...
    <div
        ...
        <div class="flex flex-col gap-4 pt-[22px]">
            <div class="flex items-center justify-between">
                ...
                <p class="font-semibold">{{ $data['duration_in_month'] }} Months</p>
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                ...
                <p class="font-semibold">{{ \Carbon\Carbon::parse($data['start_date'])->format('d M Y') }}</p>
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('assets/images/icons/calendar.svg') }}" class="w-6 h-6 flex shrink-0"
                ...
                <p class="font-semibold">{{ \Carbon\Carbon::parse($data['end_date'])->format('d M Y') }}</p>
            </div>
        </div>
    </div>
    {{-- End Booking --}}
            ...
            <div id="TabContent-Container">
                <div id="DownPayment-Tab" class="tab-content flex flex-col gap-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <p class="font-semibold">Rp {{ number_format($data['sub_total'], 0, ',', '.') }}</p>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                        ...
                        <p class="font-semibold">Rp {{ number_format($data['ppn'], 0, ',', '.') }}</p>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                        ...
                        <p class="font-semibold">Rp {{ number_format($data['insurance'], 0, ',', '.') }}</p>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                        ...
                        <p id="downPaymentPrice" class="font-semibold">Rp
                            {{ number_format($data['dp_grand_total'], 0, ',', '.') }}</p>
                    </div>
                </div>
                ...
                <div id="FullPayment-Tab" class="tab-content flex flex-col gap-4 hidden">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <p id="fullPaymentPrice" class="font-semibold">Rp
                            {{ number_format($data['fp_grand_total'], 0, ',', '.') }}</p>
                    </div>
                </div>
            </div>
        </div>
