                    ...
                    <a href="{{ route('category.show', $category) }}" class="card">
                        <div
                            ...
                            <div class="flex flex-col gap-[2px]">
                                ...
                                <p class="text-sm text-ngekos-grey">{{ $category->boarding_houses_count }} Places</p>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="swiper-wrapper">
                @foreach ($popularBoardingHouses as $popularBoardingHouse)
                    <div class="swiper-slide !w-fit">
                        <a href="{{ route('boarding-house.show', $popularBoardingHouse) }}" class="card">
                            <div
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        ...
                                        <p class="text-sm text-ngekos-grey">
                                            {{ $popularBoardingHouse->total_room_capacity }} People</p>
                                    </div>
                                    <hr class="border-[#F1F2F6]">
                ...
                <a href="{{ route('city.show', $city) }}" class="card">
                    <div
                        ...
                        <div class="flex flex-col gap-[2px]">
                            ...
                            <p class="text-sm text-ngekos-grey">{{ $city->boarding_houses_count }} Places</p>
                        </div>
                    </div>
                </a>
            @endforeach
