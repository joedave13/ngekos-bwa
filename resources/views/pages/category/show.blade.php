@extends('layouts.app', ['title' => 'Boading House by Category'])
...
@section('content')
    ...
    <div id="Header" class="relative flex items-center justify-between gap-2 px-5 mt-[18px]">
        <div class="flex flex-col gap-[6px]">
            <h1 class="font-bold text-[32px] leading-[48px]">House in {{ $category->name }}</h1>
            <p class="text-ngekos-grey">Available {{ $category->boarding_houses_count }} Places</p>
        </div>
                    ...
                    <div class="flex flex-col gap-3 w-full">
                        ...
                        <div class="flex items-center gap-[6px]">
                            <img src="{{ asset('assets/images/icons/3dcube.svg') }}" class="w-5 h-5 flex shrink-0"
                                alt="icon">
                            <p class="text-sm text-ngekos-grey">In {{ $category->name }}
                            </p>
                        </div>
                        <div class="flex items-center gap-[6px]">
