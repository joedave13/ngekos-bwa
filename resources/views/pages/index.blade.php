        ...
        <div class="grid grid-cols-2 gap-4">
            <a href="cities.html" class="card">
                <div
                    ...
                    <div
                        ...
                        <img src="assets/images/thumbnails/city-1.png" class="w-full h-full object-cover" alt="icon">
                    </div>
                    <div class="flex flex-col gap-[2px]">
            ...
            <a href="cities.html" class="card">
                <div
                    ...
                    <div
                        class="w-[55px] h-[55px] flex shrink-0 rounded-full border-4 border-white ring-1 ring-[#F1F2F6] overflow-hidden">
                        <img src="assets/images/thumbnails/city-2.png" class="w-full h-full object-cover" alt="icon">
                    </div>
                    <div class="flex flex-col gap-[2px]">
            ...
            <a href="cities.html" class="card">
                <div
                    ...
                    <div
                        class="w-[55px] h-[55px] flex shrink-0 rounded-full border-4 border-white ring-1 ring-[#F1F2F6] overflow-hidden">
                        <img src="assets/images/thumbnails/city-3.png" class="w-full h-full object-cover" alt="icon">
                    </div>
                    <div class="flex flex-col gap-[2px]">
            ...
            <a href="cities.html" class="card">
                <div
                    ...
                    <div
                        class="w-[55px] h-[55px] flex shrink-0 rounded-full border-4 border-white ring-1 ring-[#F1F2F6] overflow-hidden">
                        <img src="assets/images/thumbnails/city-4.png" class="w-full h-full object-cover" alt="icon">
                    </div>
                    <div class="flex flex-col gap-[2px]">
